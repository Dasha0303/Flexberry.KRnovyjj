    ...
    public class ТЧАктаПриемки : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧАктаПриемкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧАктаПриемкиE", typeof(IIS.KRnovyjj.ТЧАктаПриемки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТЧАктаПриемкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧАктаПриемкиL", typeof(IIS.KRnovyjj.ТЧАктаПриемки));
                }
            }
        }
    }
