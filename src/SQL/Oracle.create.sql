...
(
	...
	"ФИОЗакзачика" NVARCHAR2(255) NULL,
	...
	"ОтпускМатериала" RAW(16) NOT NULL,
...
ALTER TABLE "Заказ"
	ADD CONSTRAINT "Заказ_FОтпуск_9596" FOREIGN KEY ("ОтпускМатериала") REFERENCES "ОтпускМатериала" ("primaryKey");

CREATE INDEX "Заказ_IОтпуск_5664" on "Заказ" ("ОтпускМатериала");
