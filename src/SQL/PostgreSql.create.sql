...
CREATE INDEX Index9e1aacb51157e4a61e68f65c8e44c13dcb11991b on ТЧАктаПриемки (АктПриемки); 
 ...
 ALTER TABLE Заказ ADD CONSTRAINT FK71293cb5c4cd075688d93183d3bd43f6350fae96 FOREIGN KEY (ОтпускМатериала) REFERENCES ОтпускМатериала; 
CREATE INDEX Index71293cb5c4cd075688d93183d3bd43f6350fae96 on Заказ (ОтпускМатериала); 
